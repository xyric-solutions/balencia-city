...
- Contact sheet: `assembly/screenshots/session-88-organic-signature-wave/s88-organic-signature-wave-before-after-contact-sheet.png`
- Audit JSON: `assembly/audit/session-88-organic-signature-wave.json`
- Performance JSON: `assembly/performance-reports/session-88-performance.json`

## QA

- overview lod glbs preserved: PASS
- five hero exteriors built: PASS
- hero glbs pass import qa: PASS
- gate8 completion passed: PASS
- app hero camera evidence complete: PASS
- source manifest includes exterior hero entries: PASS
...
- `npm run build`: PASS
- local runtime asset checks: PASS; app route and all five hero GLBs returned HTTP 200
