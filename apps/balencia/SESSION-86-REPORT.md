...
- source manifest includes `exteriorHero` entries for SIA Tower, Finance, and Knowledgebase: PASS
- public asset sync copied all three hero GLBs and session 86 manifest: PASS
- focused-scene browser runtime loaded `sia-tower-ext-hero.glb`, `finance-ext-hero.glb`, and `knowledgebase-ext-hero.glb`: PASS
...
- `npm run build`
- in-app browser smoke at `http://localhost:3005/` across Scenes 1, 3, 6, and 7
